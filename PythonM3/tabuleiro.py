...
# Constantes 
CARTAS = ["Java  ", "Python", "C++   ", "Java  ", "Python", "C++   "]
CARTA_VIRADA = "******"
LINHAS = 2
COLUNAS = 3
...
while(True):
    ...
    coluna1 = int(input("Escolha o número da coluna [0,2]"))
    if (tabuleiroMostrado[linha1][coluna1]!=CARTA_VIRADA):
    ...
    coluna2 = int(input("Escolha o número da coluna [0,2]"))
    if (tabuleiroMostrado[linha2][coluna2]!=CARTA_VIRADA):
        print("Essa carta já foi virada. Tente novamente")
